                ...
                <div className="flex flex-col md:flex-row items-center gap-12">
                    ...
                    <div className="md:w-2/3">
                        ...
                        <div className="flex gap-4">
                            ...
                            target='_blank' className="w-10 h-10 text-white rounded-full flex items-center justify-center scale-120 hover:scale-135 transition-transform duration-200 ease-in-out">
                                <img src={githubSvg} alt="instagram icon links to sofiane's github" />
                            </a>
                            <a href="https://linkedin.com/in/sofiane-belhia" target='_blank' className="w-10 h-10 text-white rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-200 ease-in-out">
